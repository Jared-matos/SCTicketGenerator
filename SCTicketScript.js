...
function openNewWindow(){
    ...
    var myWindow = window.open('', 'ServiceConnect Ticket Generator', 'width=425,height=500');
    var doc = myWindow.document;
    doc.open();
    doc.write('<!DOCTYPE html>\
    <head>\
    <title>ServiceConnect Ticket Generator</title>\
...
function copyClipboard() {
    ...
    if (MBRID !== "") { 
        outputText = outputText.concat("ID: ", MBRID, "\r\n");
    } else {
        errors=errors.concat("Member ID, ");
    }
